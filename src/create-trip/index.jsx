...
const CreateTrip = () => {
 ...
 // Update the handleSelect function to correctly set the location
 const handleSelect = (event) => {
  const selectedLocation = staticLocations.find(
    (location) => location.value === event.target.value
  );
  if (selectedLocation) {
    setPlace(selectedLocation); // Set the selected location object
    handleInputChange("location", selectedLocation); // Save the entire object
  }
};
